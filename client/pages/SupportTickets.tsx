...
export default function SupportTickets() {
  ...
  const [newTicket, setNewTicket] = useState<SupportTicketRequest>({
    subject: "",
    message: "",
    priority: "medium",
    category: "general",
  ...
  const createTicket = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        success("Support ticket created successfully", "We'll respond within 24 hours");
      } else {
        showError("Failed to create support ticket");
      }
    } catch (err) {
      showError("An error occurred while creating your support ticket");
    }
  };
    ...
    return (
      <div className="min-h-screen bg-[#E7E9FF] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#637996]">Loading your support tickets...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="px-6 py-2 bg-[#3839C9] text-white font-bold text-lg rounded-lg hover:bg-blue-700 transition-colors shadow-md flex items-center gap-2"
            >
        ...
        {showNewTicketForm && (
          <div className="bg-white/80 rounded-2xl p-6 shadow-lg mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-[#20242A]">Create New Support Ticket</h2>
              <button
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3839C9]"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3839C9] resize-vertical"
                />
              </div>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-[#3839C9] text-white rounded-lg hover:bg-blue-700 transition-colors"
                >
        ...
        {filteredTickets.length > 0 ? (
          <div className="space-y-4">
            {filteredTickets.map((ticket) => (
              <div key={ticket.id} className="bg-white/80 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-[#637996] mb-4 line-clamp-2">
                      {ticket.message}
                    </p>

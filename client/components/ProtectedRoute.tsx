    ...
    return (
      <div className="min-h-screen bg-[#E7E9FF] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-[#3839C9] mb-2">Verifying access...</h2>
          <p className="text-[#637996]">Please wait while we check your permissions</p>
        </div>
      </div>
    );
  }
...
export const AdminProtectedRoute: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <ProtectedRoute requireAuth={true} requireAdmin={true} redirectTo="/login?admin=required">
    {children}
  </ProtectedRoute>
);

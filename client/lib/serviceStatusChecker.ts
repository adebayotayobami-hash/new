...
export class ServiceStatusChecker {
  ...
  private static async checkEndpoint(
    url: string,
    serviceName: string,
  ...
  public static async checkAllServices(): Promise<ServiceCheckResult> {
    ...
    try {
      ...
      services.forEach((service) => {
        const timeStr = service.responseTime
      ...
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
      console.log(
        `📊 Services Summary: ${working}/${totalChecked} working, ${failed} failed`,
      );
      ...
      if (failed === 0) {
        ...
        console.log(
          "🚨 All services are down - check network and configuration",
        );
      }
